...
import { deriveCallOverlay } from '../../src/cmps/TradeIdeas/chartOverlay.js'
import { deriveCallChartInterval, positionsForEntity } from '../../src/cmps/TradeIdeas/tradeIdea.utils.js'
import { CallDraft } from '../cmps/KairosPanel/KairosPanel.jsx'
import { HermesBadge } from '../../src/cmps/AxlHub/AgentBadges.jsx'
import { EntityPopupShell } from '../../src/cmps/EntityCard/EntityPopupShell.jsx'
import { useEntityPopup } from '../../src/customHooks/useEntityPopup.js'
import { isAwaitingConfirm, isLivePosition, isTerminal, isInvalidated } from '../../src/services/entityStatus.js'
import { PopoutFooter } from '../../src/cmps/TradeIdeas/PopoutFooter.jsx'
import { MonitorJournal } from '../../src/cmps/TradeIdeas/MonitorJournal.jsx'
// Shared with the setup pop-out — `position_state` is one shape whatever desk wrote it.
import { PositionPanel } from '../../src/cmps/TradeIdeas/PositionPanel.jsx'
import { PriceChart } from '../../src/cmps/PriceChart/PriceChart.jsx'
import { usePositions } from '../../src/customHooks/usePositions.js'
