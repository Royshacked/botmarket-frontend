...
const mk = (over = {}) => ({
    ...
    setup: {
        ...
        entry_legs: [{ id: 'ez1', price: 201 }],
        stop_legs:  [{ id: 'sz1', price: 196 }],
        target_legs:    [{ id: 'tp1', price: 210 }],
...
const TWO = [
    mk(),
    mk({ label: 'Break of the shelf', pitch: 'Momentum version — worse fill.', setup: { direction: 'long', trade_mode: 'classical', rr: 1.2, entry_legs: [{ id: 'ez1', price: 206 }], stop_legs: [{ id: 'sz1', price: 202 }], target_legs: [{ id: 'tp1', price: 214 }] } }),
]
...
describe('CandidatePicker', () => {
    ...
    it('renders a zero-width zone as a single price, not a degenerate range', () => {
        const exact = [mk({ setup: { entry_legs: [{ id: 'ez1', price: 200 }], stop_legs: [], target_legs: [] } })]
