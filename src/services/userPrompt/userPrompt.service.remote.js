 ...
 */
async function sendPromptStream(userPrompt, analysisState = null, brokerContext = null, { onToken, onDone, onError, onAsset } = {}) {
    const res = await fetch(`${STREAM_BASE_URL}/orchestrator/stream`, {
        method:      'POST',
        credentials: 'include',
        headers:     { 'Content-Type': 'application/json' },
        body:        JSON.stringify({ userPrompt, analysisState, brokerContext }),
    })
