...
async function sendStream(messages, opts = {}) {
    const { model, reasoningEffort, routingMode, currentPhase, signal, accounts = [], chatState, seed } = opts
    await postSSE(
        `${API_BASE}/${BASE}/stream`,
        { messages, model, reasoningEffort, routingMode, currentPhase, accounts, chatState, seed },
