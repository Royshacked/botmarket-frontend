...
export function RootCmp() {
    ...
    // Header style trial: 'axl' (new) by default, 'classic' = the original saved
    // style. Flip live with: localStorage.setItem('headerStyle','classic'); reload.
    const useAxlHeader = localStorage.getItem('headerStyle') !== 'classic'
    ...
    return (
        <>
            <div className={`main-container${user ? '' : ' app-blurred'}`}>
                {useAxlHeader ? <AppHeaderAxl /> : <AppHeader />}
